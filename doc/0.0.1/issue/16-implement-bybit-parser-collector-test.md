# Issue 16: Implement @BybitParserCollector.java test

In this `crypto-scout-collector` project we are going to implement the @BybitParserCollectorTest.java test service by
cover the application logic of @BybitParserCollector.java with tests.
...
- As the `expert java engineer` review the current @BybitParserCollector.java implementation in `crypto-scout-collector`
  project and update @BybitParserCollectorTest.java by implementing tests methods to cover logic in the
  @BybitParserCollector.java, use @BybitLinearRepositoryTest.java, @BybitSpotRepositoryTest.java,
