...
select add_compression_policy('crypto_scout.bybit_ta_linear_public_trade', interval '7 days');
select add_reorder_policy('crypto_scout.bybit_ta_linear_public_trade', 'idx_bybit_ta_linear_public_trade_trade_time');
select add_retention_policy('crypto_scout.bybit_ta_linear_public_trade', interval '180 days');
...
select add_compression_policy('crypto_scout.bybit_ta_linear_order_book_1', interval '7 days');
select add_compression_policy('crypto_scout.bybit_ta_linear_order_book_50', interval '7 days');
select add_compression_policy('crypto_scout.bybit_ta_linear_order_book_200', interval '7 days');
select add_compression_policy('crypto_scout.bybit_ta_linear_order_book_1000', interval '7 days');
...
select add_retention_policy('crypto_scout.bybit_ta_linear_order_book_1', interval '7 days');
select add_retention_policy('crypto_scout.bybit_ta_linear_order_book_50', interval '7 days');
select add_retention_policy('crypto_scout.bybit_ta_linear_order_book_200', interval '7 days');
select add_retention_policy('crypto_scout.bybit_ta_linear_order_book_1000', interval '7 days');
...
select add_compression_policy('crypto_scout.bybit_ta_linear_all_liqudation', interval '7 days');
select add_reorder_policy('crypto_scout.bybit_ta_linear_all_liqudation', 'idx_bybit_ta_linear_all_liqudation_event_time');
select add_retention_policy('crypto_scout.bybit_ta_linear_all_liqudation', interval '730 days');
